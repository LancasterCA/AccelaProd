/*------------------------------------------------------------------------------------------------------/
| Program		: ASSET_USAGE_SERVICE_V8.js
|
...
var scriptStatus = "";
var scriptDate = "2018.09.24 11:16";
...
Asset.prototype.addAssetFleetUsage = function (newReading, readingDate, comment, customAttributeField) {
    ...
    if (asset.getGroup() == "Fleet") {
        ...
        if (newReading > lastReading) {
			...
			scriptStatus = scriptStatus + "| asset.createUsage(newReading:" + newReading + ",readingDiff" + readingDiff + ",unit" + unit + ",readingDate" + readingDate ;
