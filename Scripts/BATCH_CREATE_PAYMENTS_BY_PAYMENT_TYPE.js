/*------------------------------------------------------------------------------------------------------/
| Program: Batch_Create_Payments_by_Payment_Type.js  Trigger: Batch
| Client: Lancaster CA
| Partner:  Silver Lining Solutions, Copywrite 2018
|
| Frequency: Run Daily
|
| Desc: This batch script will create a Payments by Payment Type report and Email it to Lancaster 
...
//aa.env.setValue("BatchJobName", "Create PaymentsbyPaymentType");
...
function mainProcess() {
	...
	var curDay = ("0" + (reportDate.getDate() )).slice(-2);
			...
			//Generate the Report 
						...
						var tmpRPTFName = "Payments_by_Payment_Type_"+ reportDate.getFullYear() + curMonth + reportDate.getDate() + ".xls";
emailText += br+"the file name is>"+tmpRPTFName+"<";
//printObjProperties(myParams);
emailText += br+ curMonth + "/" + curDay + "/" + reportDate.getFullYear();
						generateReportAndEmail("Payments by Payment Type", myParams,"Licenses",tmpRPTFName,emailAddress,"Payments_by_Payment_Type");
