...
var addCondition = getParam("addCondition"); 
...
//				licCap = getLicenseCapId("*/*/*/*");
		...
		// addCondition
		logDebug("addCondition: " + addCondition);
		if (addCondition && addCondition.substring(0, 1).toUpperCase().equals("Y")) {
			// place a hold condition on this renewal
			var conditionGroup = "Licensing",
				conditionType = "Cannabis Licensing",
				conditionName = "Cannabis Expired License",
				conditionComment = "The License Expiration Date was exceeded.",
				impactCode = "Lock",
				condStatus = "Applied",
				auditStatus = "A",
				displayNotice = "Y",
